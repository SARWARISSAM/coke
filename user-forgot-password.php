...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblemployees WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblemployees set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>TAMS | Password Recovery </title>
...
<div class="col-md-12">
<h4 class="header-line">Employee Password Recovery</h4>
</div>
</div>
